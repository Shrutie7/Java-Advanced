...
public class MyThreadLifeCycle4 extends Thread {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        t1.join(); //
        System.out.println(t1.getState()); // jis thread pe call krre usko finish hone ka wait krra main thread chala raha isko main thread --> main method'll wait for t1 to get finished tabhi main method will continue further
